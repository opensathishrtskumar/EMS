...
public class ExcelReportWorker implements Callable<Object> {
	...
	public String call() throws Exception {
		...
		String reportMsg = "Report created at " + file.getAbsolutePath();
		...
		try {
			...
			for (int j = 0; j < taskSubmitted; j++) {
				...
				try {
					...
					Map<DeviceDetailsDTO, List<PollingDetailDTO>> workerResponse = (Map<DeviceDetailsDTO, List<PollingDetailDTO>>)response.get();
			...
			reportMsg = "Report creation failed, Please try again." + e.getMessage() ;
		}
